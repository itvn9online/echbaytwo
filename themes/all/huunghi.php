...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "huunghi-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "huunghi-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "huunghi-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "huunghi-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "huunghi-threadnode.html";
