<?php
/*
 * Save from Sat, 10 Oct 2020 08:51:32 +0700
 * By itvn9online@yahoo.com #1
 * From IP: ::1
 * On domain: localhost:8888
 * User agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.121 Safari/537.36
 */
$eb_all_themes_name = basename( __FILE__, '.php' );
$eb_all_themes_support[ $eb_all_themes_name ] = array();
$eb_all_themes_support[ $eb_all_themes_name ][ "name" ] = $eb_all_themes_name;
$eb_all_themes_support[ $eb_all_themes_name ][ "screenshot" ] = "https://img1.webgiare.org/$eb_all_themes_name.jpg";
$eb_all_themes_support[ $eb_all_themes_name ][ "author" ] = "";
$eb_all_themes_support[ $eb_all_themes_name ][ "demo" ] = "";
$eb_all_themes_support[ $eb_all_themes_name ][ "price" ] = 600000;
//
$eb_all_themes_support[ $eb_all_themes_name ][ "top" ][] = "$eb_all_themes_name-top1.php";
...
// breadcrumb tràn màn hình (kèm nền mặc định)
...
$eb_all_themes_support[ $eb_all_themes_name ][ "footer" ][] = "$eb_all_themes_name-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "$eb_all_themes_name-home1.php";
$eb_all_themes_support[ $eb_all_themes_name ][ "home" ][] = "home_widget.php";
//
$eb_all_themes_support[ $eb_all_themes_name ][ "threaddetails" ][] = "$eb_all_themes_name-threaddetails.html";
//
$eb_all_themes_support[ $eb_all_themes_name ][ "threadnode" ][] = "$eb_all_themes_name-threadnode.html";