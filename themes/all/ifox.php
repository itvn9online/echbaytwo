...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "ifox-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "ifox-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "ifox-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "ifox-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "ifox-threadnode.html";
