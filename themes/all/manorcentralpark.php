...
*/
$eb_all_themes_name = 'manorcentralpark';
$eb_all_themes_support[$eb_all_themes_name] = array();
$eb_all_themes_support[$eb_all_themes_name]["name"] = $eb_all_themes_name;
$eb_all_themes_support[$eb_all_themes_name]["screenshot"] = "https://img1.webgiare.org/manorcentralpark.jpg";
...
//
//$eb_all_themes_support[$eb_all_themes_name]["top"][] = "manorcentralpark-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "manorcentralpark-footer1.php";
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "manorcentralpark-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "manorcentralpark-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "manorcentralpark-threadnode.html";
