<?php 
/*
* Save from Thu, 24 Dec 2020 21:57:48 +0700
* By itvn9online@yahoo.com #1
* From IP: ::1
* On domain: localhost:8888
* User agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36
*/
$eb_all_themes_name = 'phuonghoalifecoach';
$eb_all_themes_support[$eb_all_themes_name] = array();
$eb_all_themes_support[$eb_all_themes_name]["name"] = $eb_all_themes_name;
$eb_all_themes_support[$eb_all_themes_name]["screenshot"] = "https://img1.webgiare.org/phuonghoalifecoach.jpg";
$eb_all_themes_support[$eb_all_themes_name]["author"] = "";
$eb_all_themes_support[$eb_all_themes_name]["demo"] = "";
$eb_all_themes_support[$eb_all_themes_name]["price"] = 150000;
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "phuonghoalifecoach-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "phuonghoalifecoach-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "phuonghoalifecoach-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "phuonghoalifecoach-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "phuonghoalifecoach-threadnode.html";
