...
*/
$eb_all_themes_name = 'beegital';
$eb_all_themes_support[$eb_all_themes_name] = array();
$eb_all_themes_support[$eb_all_themes_name]["name"] = $eb_all_themes_name;
$eb_all_themes_support[$eb_all_themes_name]["screenshot"] = "https://img1.webgiare.org/beegital.jpg";
...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "beegital-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "beegital-footer1.php";
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "echbaytwo-footer3.php";
//
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "beegital-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "beegital-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "beegital-threadnode.html";
